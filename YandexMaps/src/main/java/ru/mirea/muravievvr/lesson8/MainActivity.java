package ru.mirea.muravievvr.lesson8;
...
import ru.mirea.muravievvr.lesson8.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements UserLocationObjectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int loc1PermissionStatus = ContextCompat.checkSelfPermission(this,
                android.Manifest.permission.ACCESS_COARSE_LOCATION);
        int loc2PermissionStatus = ContextCompat.checkSelfPermission(this,
